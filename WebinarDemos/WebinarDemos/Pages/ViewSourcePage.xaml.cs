...
namespace WebinarDemos
{
	public partial class ViewSourcePage : ContentPage
	{
		...
		string GetXamlForType(Type type)
		{
		...
		bool ResourceMatchesFilename(Assembly assembly, string resource, string filename)
		{
			try
			{
		...
		string ReadResourceAsXaml(Type type, Assembly assembly, string likelyTargetName, bool validate = false)
		{
